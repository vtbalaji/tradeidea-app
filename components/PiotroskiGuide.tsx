    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border border-blue-200 dark:border-blue-800/30 rounded-xl p-6">
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">
            Understanding Piotroski Score vs Fundamental Score
          </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-white dark:bg-[#0f1419] border border-blue-200 dark:border-blue-800/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-bold text-gray-900 dark:text-white">Piotroski F-Score (0-9)</h4>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            <p className="text-xs text-gray-600 dark:text-[#8b949e] italic">
              Evaluates 9 criteria: profitability (4), leverage (3), operating efficiency (2)
            </p>
          </div>
        </div>
      ...
      <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/30 rounded-lg p-4">
        ...
        <div className="space-y-3 text-sm text-amber-900 dark:text-amber-200">
          <div className="flex items-start gap-2">
            <span className="font-bold min-w-[140px]">High Piotroski (6/9) + Good Fundamental:</span>
            <span>✅ Ideal - Strong financial health AND attractive valuation</span>
          </div>

          <div className="flex items-start gap-2">
            <span className="font-bold min-w-[140px]">Low Piotroski (3/9) + Good Fundamental:</span>
          ...
          <div className="flex items-start gap-2">
            <span className="font-bold min-w-[140px]">High Piotroski (6/9) + Weak Fundamental:</span>
            <span>🤔 Mixed - Financially healthy but expensive valuation or slow growth</span>
          </div>

          <div className="flex items-start gap-2">
            <span className="font-bold min-w-[140px]">Low Piotroski (3/9) + Weak Fundamental:</span>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 dark:text-blue-300">
              <strong>Use both scores together!</strong> A company with GOOD Fundamental Score but low Piotroski (3/9) is revealing important information -
