...
export const TradingProvider: React.FC<TradingProviderProps> = ({ children }) => {
  ...
  // Alert checking is now handled by backend service (scripts/check-and-generate-alerts.py)
  // This runs daily as part of the EOD batch job
  // Frontend only listens to notifications via the notifications useEffect below
