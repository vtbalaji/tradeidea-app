...
export default function VerifyEmailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1419] flex items-center justify-center px-4">
      <div className="bg-[#1c2128] rounded-xl p-8 w-full max-w-md border border-[#30363d] text-center">
        {/* Logo */}
        ...
        {checking ? (
          <>
            <h1 className="text-2xl font-bold text-white mb-4">Checking Verification...</h1>
          ...
          <>
            ...
            <div className="bg-[#0f1419] border border-[#30363d] rounded-lg p-4 mb-6 text-left">
              <p className="text-sm text-[#8b949e] mb-2">Next steps:</p>
            ...
            <button
              ...
              className="w-full bg-[#30363d] hover:bg-[#3c444d] text-white font-semibold py-3 px-4 rounded-lg transition-colors"
            >
              Back to Login
            </button>
          </>
