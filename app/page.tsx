  ...
  return (
    <div className="min-h-screen bg-[#0f1419]">
      ...
      <nav className="border-b border-[#30363d]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold text-white">TradeIdea</span>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() => router.push('/login')}
              className="px-4 py-2 text-white hover:text-[#ff8c42] transition-colors font-semibold"
            >
              Login
            </button>
            <button
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <button
            ...
            className="px-8 py-4 bg-[#1c2128] hover:bg-[#30363d] border border-[#30363d] text-white text-lg font-semibold rounded-lg transition-colors"
          >
            Explore Ideas
          </button>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-white text-center mb-12">Why TradeIdea?</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-[#1c2128] border border-[#30363d] rounded-xl p-6 text-center">
            <div className="text-5xl mb-4">💡</div>
            <h3 className="text-xl font-bold text-white mb-3">Share Trading Ideas</h3>
          ...
          <div className="bg-[#1c2128] border border-[#30363d] rounded-xl p-6 text-center">
            <div className="text-5xl mb-4">📊</div>
            <h3 className="text-xl font-bold text-white mb-3">Track Your Portfolio</h3>
            <p className="text-[#8b949e]">
          ...
          <div className="bg-[#1c2128] border border-[#30363d] rounded-xl p-6 text-center">
            <div className="text-5xl mb-4">👥</div>
            <h3 className="text-xl font-bold text-white mb-3">Follow Top Traders</h3>
            <p className="text-[#8b949e]">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Explore & Share</h3>
            <p className="text-[#8b949e]">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Track & Grow</h3>
            <p className="text-[#8b949e]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-white">TradeIdea</span>
            </div>
