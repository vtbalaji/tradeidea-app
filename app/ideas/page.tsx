          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                title="More actions"
              >
                <svg width="20" height="20" viewBox="0 0 24 24" fill="#ff8c42">
              ...
              {openMenuId === idea.id && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 hover:bg-orange-500/10 text-gray-900 dark:text-white hover:text-[#ff8c42] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-left"
                  >
