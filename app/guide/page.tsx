      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-12 bg-gray-50 dark:bg-[#1c2128] border border-gray-200 dark:border-[#30363d] rounded-xl p-6">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <a href="#scores-calculations" className="text-[#ff8c42] hover:underline">6. Understanding Scores & Ratings</a>
            <a href="#investment-tracking" className="text-[#ff8c42] hover:underline">7. Smart Investment Tracking</a>
            <a href="#investment-ideas" className="text-[#ff8c42] hover:underline">8. Investment Ideas Community</a>
            <a href="#notifications" className="text-[#ff8c42] hover:underline">9. Notifications & Alerts</a>
          </div>
        </div>
